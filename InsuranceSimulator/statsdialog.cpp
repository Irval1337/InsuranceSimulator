    ...
    ui(new Ui::StatsDialog), data(data_)
{
    ...
    ui->lineEdit_3->setText(QString::number(data_.total_payment_amount()) + "$");
    ui->lineEdit_4->setText(QString::number(data_.month_payment_amount()) + "$");
    ui->lineEdit_5->setText(QString::number(data_.total_revenue()) + "$");
    ui->lineEdit_6->setText(QString::number(data_.month_revenue()) + "$");
